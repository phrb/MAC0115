...
*** mini-EP4: Exercícios do Capítulo 3. Funções                  :noexport:
1. Abra o Notebook do Capítulo 3 [[https://phrb.github.io/PenseJulia/][aqui]], ou em sua *instalação local do Jupyter*
2. Usando a *interface* do Notebook:
   1. Faça os exercícios (quais?)
3. *Salve* seu trabalho
4. Se estiver usando o *Binder*, faça o *download do notebook com o seu trabalho*
5. Entregue seu Notebook no PACA
   1. O formato do arquivos *deve ser =.ipynb=, ou =.jl=*
   2. O nome do arquivo deve ser no formato =Seu_Nome_miniEP4.ipynb= (exemplo: =Alfredo_Goldman_miniEP4.ipynb=)
   3. A data de entrega é (*quando*?)
